...
library(ggplot2)
library(stargazer)
Harper.data <- read_csv("~/Desktop/Boras Corp work/Research Questionnaire R Work/Harper.Data.csv")
Machado.data <- read_csv("~/Desktop/Boras Corp work/Research Questionnaire R Work/Machado.Data.csv")
